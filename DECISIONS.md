...
**Consequences:** All end-of-run displays (HUD, Flight Data panel, crash diagnostic messages) read from the same frozen snapshot. No more mismatches. Pre-contact tracking adds three CGFloat assignments per frame — negligible overhead.
